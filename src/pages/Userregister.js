...
import { postuseremaliotp , postuseremaliotpverify , postuserregisterUser} from '../Api/Api';
                ...
                <Col>
                    ...
                    <Form>
                        ...
                        <Row>
                            ...
                            <Col lg={4} md={3} className="ps-md-0 text-end">
                        ...
                        <div className='sign_button_main'>
                            ...
                            <p className='my-2'>Already have an account ? <a href='/Userlogin' className='color_link'> Sign In</a></p>
                        </div>    
                    </Form>
                </Col>
            </Row>
